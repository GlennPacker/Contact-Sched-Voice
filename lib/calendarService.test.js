import { calcStart, utcToZulu, createAppointment, getEndDate, calcReocurance, contactCreateAppointment } from './calendarService.js';
...
describe('calendarService', () => {
  ...
  describe('contactCreateAppointment', () => {
    it('calls createAppointment with correct arguments and returns its result', () => {
      ...
      const url = contactCreateAppointment({ contactName: 'John Doe', visit: {
        date: '2025-07-15',
        note: 'Test note',
        time: 'full day',
        days: '',
        isInside: true,
        recurrence: '2 weeks'
      }, address: 'Paris' }, mockCreateAppointment);
