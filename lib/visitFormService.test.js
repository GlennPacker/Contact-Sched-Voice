...
describe('visitFormService', () => {
  test('getTomorrowMinDate returns tomorrow in YYYY-MM-DD', () => {
    ...
    expect(getTomorrowMinDate()).toBe(expected)
  })
  ...
  test('getVisibleVisitPositions filters by cutoff and sorts by date', () => {
    const fields = [
    ...
    const positions = getVisibleVisitPositions({ fields, watchedVisits: watched, cutoffDays: 36500 })
