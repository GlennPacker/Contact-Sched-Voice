describe('contactService', () => {
  ...
  it('getContact returns mapped contact and throws on error', async () => {
    const row = { id: 5, name: 'Zed', rateFullDay: 100, facebookGlenn: 'fb', addresses: [{ id: 11, address: '1 Road', visits: [{ id: 21, visitDate: '2026-01-01', earliestDate: null, notes: 'n', isInside: true, isFlexilbe: false, time: 'full', recurrence: 'none', visitTypeId: 4 }] }] };
    ...
    expect(contact.addresses[0].visits[0].visitTypeId).toBe(4);
