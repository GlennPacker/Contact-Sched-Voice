import { calcReocurance, calcStart, contactCreateAppointment, getEndDate, utcToZulu } from './visitUtils.js';
...
describe('calendarService', () => {
  ...
  describe('getEndDate', () => {
    ...
    it('adds 3.5 hours for half day', () => {
      const start = new Date(Date.UTC(2025, 0, 1, 9, 0, 0));
  ...
  describe('calcReocurance', () => {
    it('returns correct RRULE for 2 weeks', () => {
      expect(calcReocurance('2 weeks')).toBe(14);
    });
    it('returns correct RRULE for 3 weeks', () => {
      expect(calcReocurance('3 weeks')).toBe(21);
    });
    it('returns correct RRULE for 4 weeks (monthly)', () => {
      expect(calcReocurance('4 weeks (monthly)')).toBe(28);
    });
