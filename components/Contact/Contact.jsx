...
export default function Contact({ initialValues = null, submit, title, priceReviewDateReadOnly = false }) {
  ...
  useEffect(() => {
    if (!addressFields.length) addAddress({ address: '' });
    ...
    <>
      <Form onSubmit={handleSubmit(formSubmit)}>
        ...
        <div className={styles.formGrid}>
          <div className={styles.formGridCol1}>
            <Form.Group
              className="mb-3"
              controlId="name">
          ...
          <div className={styles.formGridCol2}>
            <Addresses
