...
import styles from './VisitsArrayInput.module.scss';
              ...
              {isCollapsed ? (
                <div className={styles['visit-collapsed-summary']}>
                  <span
                    ...
                    role="button"
                    tabIndex={0}
                    onClick={() => collapseToggle(idx)}
                    onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') collapseToggle(idx) }}
