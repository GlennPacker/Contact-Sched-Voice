...
export default function SortIcon({ field, activeField, activeDir, onChange }) {
  ...
  if (!isActive) {
    return (
      <button type="button" className="btn btn-link p-0 ms-2" onClick={handleClick} aria-label={`sort ${field}`}>
  ...
  if (activeDir === 'asc') {
    return (
      <button type="button" className="btn btn-link p-0 ms-2" onClick={handleClick} aria-label={`sort ${field} asc`}>
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
  ...
  return (
    <button type="button" className="btn btn-link p-0 ms-2" onClick={handleClick} aria-label={`sort ${field} desc`}>
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
